...
@section('Content')
    <div>
        <p class="text-2xl font-semibold">Form Input Lomba</p>
        <p class="text-sm text-gray-700 font-normal">Form Pengisian Data Perlombaan Lobi Poliwangi</p>
                ...
                <div class="flex flex-row justify-between items-center px-5">
                    <div>
                        ...
                        <div class="relative z-0 w-96 mb-5">
                            <input name="NamaPerlombaan" value="{{ old('NamaPerlombaan') }}" autocomplete="off" type="text" id="floating_standard" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                        ...
                        <div>
                            <label for="message" class="block mb-2 text-sm font-medium text-gray-900">Persyaratan Perlombaan</label>
                    ...
                    <div class="flex flex-col items-center gap-y-3">
                        <p class="text-black font-semibold text-[20px]">Upload Brosur Lomba</p>
                ...
                <div class="flex flex-row">
                    ...
                    <button id="SubmitButton" onclick="confirm('Ingin Menyimpan Instansi Ini')" type="submit" class="disabled-submit-button ml-5 p-3 pl-8 pr-8 mt-10 mb-10 w-96 rounded-md" disabled>
                        <div class="flex flex-row justify-center items-center w-full h-full gap-x-2">
                            ...
                            <p class="text-gray-100 font-semibold">Simpan Lomba</p>
                        </div>
                    </button>
                </div>
            </form>
